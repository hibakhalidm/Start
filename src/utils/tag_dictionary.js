...
export const getTagInfo = (tag) => {
    ...
    if ((tag & 0xC0) === 0x80)
        return { name: `Context [${tag & 0x1F}]`, description: "Context-specific tag defined by the protocol schema.", category: "Context" };
    if ((tag & 0xC0) === 0x40)
        return { name: `App [${tag & 0x1F}]`, description: "Application-specific tag.", category: "Application" };
